...
$temporaryDirectoryName = 'herta-malformed-ui-test-' + [System.Guid]::NewGuid().ToString('N')
...
try {
    ...
    [System.IO.File]::WriteAllText($dataFile, 'T | 2 | invalid status', $utf8Encoding)
    ...
    $isExpectedTemporaryDirectory = $hasCreatedTemporaryDirectory `
        ...
        -and $temporaryDirectoryName.StartsWith('herta-malformed-ui-test-', [System.StringComparison]::Ordinal)
