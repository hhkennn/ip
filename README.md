...
1. After that, locate the `src/main/java/Herta.java` file, right-click it, and choose `Run Herta.main()` (if the code editor is showing compile errors, try restarting the IDE). If the setup is correct, you should see something like the below as the output:
   ```
    _   _           _
   | | | | ___ _ __| |_ __ _
   | |_| |/ _ \ '__| __/ _` |
